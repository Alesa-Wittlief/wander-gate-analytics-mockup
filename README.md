...
The core features of this project were built to alleviate the boredom, or anxiety, or hunger that travelers feel when they have a long wait at their assigned gate at the airport. The features include a pop-up that asks, 
"See what's nearby" in order to guide them away from the crowded areas to restaurants, cafes, shops, and any surprising entertainment or restful areas that they may not have been aware of. This app is built with the goal 
of offering solutions, showing an approximate wait-time, but won't track location or ask privacy questions, such as asking about food allergies, etc. 
...
- **Framework:** DB Browser for SQLite
...
- **Community Chat:** Join the conversation over at [Discord](https://discord.gg).
- **Email Support:** Reach out directly at `maintainer@example.com`.
